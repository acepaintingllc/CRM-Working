-- Re-apply the full Estimator V2 persistence RPC after adding Estimate V2
-- prejob trip MVP fields. Previously-applied environments do not re-run
-- migration 087, so the updated prejob insert/update contract must be
-- deployed in a later migration.
