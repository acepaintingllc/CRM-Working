...
export type UseQuoteVersionWorkflowOptions = {
  jobId: string
...
export function useQuoteVersionWorkflowController({
  jobId,
  selectedJob,
  loading = false,
...
export type QuoteVersionWorkflowController = ReturnType<typeof useQuoteVersionWorkflowController>
