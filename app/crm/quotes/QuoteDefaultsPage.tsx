...
export default function QuoteDefaultsPage() {
  ...
  const [settings, setSettings] = useState<QuoteDefaults | null>(null)
  const [savedSnapshot, setSavedSnapshot] = useState<QuoteDefaults | null>(null)
  ...
  const save = async () => {
    ...
    try {
      ...
      setError(null)
      setSaved(null)
      const result = await saveQuoteDefaults(settings)
