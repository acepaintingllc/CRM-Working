...
import { PATCH } from '../quotes/products/[id]/route'
...
describe('quote products [id] route', () => {
  beforeEach(() => {
  ...
  it('rejects invalid merged product payloads with field errors', async () => {
    ...
    const response = await PATCH(new Request('http://localhost/api/quotes/products/id'), {
